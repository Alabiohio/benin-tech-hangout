    ...
    return (
        <section className="relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="bg-slate-900 rounded-4xl p-6 md:p-10 text-center max-w-2xl mx-auto shadow-2xl" data-aos="zoom-out" data-aos-duration="1000">
                    <h2 className="text-2xl md:text-3xl font-black font-cabinet-grotesk text-white mb-1">Powered By</h2>
