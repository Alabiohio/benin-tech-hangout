    ...
    return (
        <footer id="contact" className="relative z-10 bg-white text-white py-4 overflow-hidden">
            ...
            <div className="container mx-auto relative z-10 px-4 md:px-8 pt-8">
                ...
                <div className="relative my-6 rounded-2xl overflow-hidden border border-[#25D366]/30 bg-gradient-to-r from-[#25D366]/10 via-[#128C7E]/10 to-[#25D366]/10">
                    <div className="relative flex flex-col sm:flex-row items-center justify-between gap-4 px-6 py-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="relative flex-shrink-0">
                                ...
                                <div className="relative w-10 h-10 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg shadow-[#25D366]/40">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-black uppercase tracking-wide text-slate-300">Join our WhatsApp channel for live updates &amp; announcements</p>
                            </div>
                        </div>
                        ...
                        <a
                            ...
                            className="flex-shrink-0 flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#25D366] text-white font-black font-oswald uppercase tracking-widest text-sm hover:bg-[#1da851] hover:shadow-[0_0_20px_rgba(37,211,102,0.4)] transition-all duration-300 group"
                        >
                            Join Channel
