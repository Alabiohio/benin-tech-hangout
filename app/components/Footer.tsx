                    ...
                    <div className="relative flex flex-col sm:flex-row items-center justify-between gap-4 px-4 py-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-black uppercase font-oswald text-slate-700">Join our WhatsApp channel for live updates &amp; announcements</p>
                            </div>
                        </div>
                        ...
                        <a
                            ...
                            className="flex-shrink-0 flex items-center gap-2 px-5 py-2.5 rounded-full bg-biro-blue-dark text-white font-black font-oswald uppercase tracking-widest text-sm hover:bg-biro-blue hover:border hover:border-3 hover:border-bg-biro-blue hover:bg-transparent hover:text-biro-blue-dark transition-all duration-300 group"
                        >
                            Join Channel
