        ...
        >
            <div className="container mx-auto px-4 md:px-8 h-12 md:h-14 flex items-center relative z-[101]">
                ...
                <nav className="hidden lg:flex items-center gap-8 text-[13px] font-bold uppercase tracking-widest transition-colors duration-300 text-colors-inverted mr-8">
                    ...
                    <Link href="/speaker-registration" className="hover:text-biro-blue-dark transition-colors">Apply to Speak</Link>
            ...
            <div className={`fixed inset-0 bg-background lg:hidden transition-all duration-300 ease-in-out z-[200] flex flex-col ${isMenuOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
                ...
                <div className="flex flex-col -mt-5 items-center justify-center flex-1 gap-1 overflow-y-auto">
                    ...
                    <Link href="/speaker-registration" className="text-[43px] sm:text-[35px] md:text-[40px] font-bold tracking-tight text-foreground" onClick={handleLinkClick}>Apply to Speak</Link>
